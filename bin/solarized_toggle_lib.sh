...
ST_STORAGE=${XDG_STATE_HOME:-$HOME/.local/state}/solarizedtoggle
...
st_set_xrdb() {
	...
	local xres=${XDG_CONFIG_HOME:-$HOME/.config}/X11/Xresources
	local xres_symlink=$ST_STORAGE/Xresouces_theme
	local xres_dark=${XDG_CONFIG_HOME:-$HOME/.config}/X11/Xresources.solarized_dark
	local xres_light=${XDG_CONFIG_HOME:-$HOME/.config}/X11/Xresources.solarized_light
