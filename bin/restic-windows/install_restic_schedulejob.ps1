...
$action = New-ScheduledTaskAction -Execute 'C:\Program Files\Git\git-bash.exe' -Argument '-l -c "/c/Users/erikw/bin/restic/usr/local/sbin/restic_backup.sh"'
...
$action = New-ScheduledTaskAction -Execute 'C:\Program Files\Git\git-bash.exe' -Argument '-l -c "/c/Users/erikw/bin/restic/usr/local/sbin/restic_check.sh"'
